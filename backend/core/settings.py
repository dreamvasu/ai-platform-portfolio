...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "django-insecure-3!0o)7i&m)@y=11#uvw25u#48)0wrfj**fhmbb$a137ugyxmwe")
...
if DATABASE_URL:
    # Use PostgreSQL from DATABASE_URL (Cloud SQL)
...
CORS_ALLOWED_ORIGINS = os.getenv(
    ...
    "http://localhost:5173,http://127.0.0.1:5173,https://vasukapoor.com,https://www.vasukapoor.com"
).split(",")
